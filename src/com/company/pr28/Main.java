...
public class Main {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Тыгыдык \uD83D\uDC0E \uD83D\uDC0E \uD83D\uDC0E тыгыдык \uD83D\uDC0E \uD83D\uDC0E \uD83D\uDC0E тыгыдык \uD83D\uDC0E \uD83D\uDC0E \uD83D\uDC0E");
        String[] expressions = {
                "(((3+5)-9*4)-7)+11",
                "(3-7)*(2-6)",
                "((5+6)-8",
            ...
            if(count1 != count2)
                ...
                for(int i = 0; i < count1; i++){
                    if(Pattern.matches("\\(?[0-9|x]([+\\-*/][0-9|x])*\\)?", cut(expression))) {
                        // меняем выражения в скобках на 'x' с самого внутреннего,
                        // если оно подходит под регулярное выражение
